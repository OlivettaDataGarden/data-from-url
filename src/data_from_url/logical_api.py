...
from .helper import make_request_with_method, remove_none_values, \
...
CONNECTIVITY_ERROR_RESPONSE = GetDataResponse(
    response=None, is_valid=False, data=None,
...
class LogicalApi():
    ...
    def _do_request(**query_params: dict) -> GetDataResponse:
        ...
        return GetDataResponse(
            response=response, is_valid=True, data=None, error_msg=[],
