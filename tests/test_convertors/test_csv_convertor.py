...
"""
import pytest
from data.test_data import CONVERTOR_PARAMS_CSV, CSV_GET_DATA_RESPONSE, \
...
def test_csv_converter_returns_dict():
    ...
    """
    assert isinstance(CSVConvertor._result_with_data_field(
        CSV_GET_DATA_RESPONSE, CONVERTOR_PARAMS_CSV).data, dict)
...
def test_csv_converter_returns_header_with_non_lower_char():
    ...
    result = CSVConvertor._result_with_data_field(
        CSV_GET_DATA_RESPONSE, convertor_params).data
