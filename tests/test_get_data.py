...
def test_get_data_resul_method_calls_query_params_validator(mocker):
    ...
    """
    mocker.patch('data_from_url.proxy.GetProxiedQueryParams.get_query_params',
                 return_value=None)
    mocker.patch('data_from_url.logical_api.LogicalApi.result',
                 return_value=None)
...
def test_proxied_queries_called_without_proxy_argument(mocker):
    ...
    mocker.patch('data_from_url.logical_api.LogicalApi.result',
                 return_value=None)
    proxy_query_params_spy = mocker.spy(
