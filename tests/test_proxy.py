...
def test_get_proxied_query_params_without_proxy_returns_query_params():
    ...
    assert (
        GetProxiedQueryParams.get_query_params(query_params=query_params)
        == query_params
    )
...
def test_proxy_argument_is_removed_from_query_params(mocker):
    ...
    new_query_params = GetProxiedQueryParams.get_query_params(query_params=query_params)
...
def test_get_proxied_query_params_with_non_existing_proxy():
    ...
    with pytest.raises(ValueError):
        GetProxiedQueryParams.get_query_params(query_params={"proxy": "DOES_NOT_EXIST"})
